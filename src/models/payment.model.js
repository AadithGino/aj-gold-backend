...
paymentSchema.index({ scheme: 1, status: 1, paymentDate: -1 });
paymentSchema.index({ customer: 1, status: 1, paymentDate: -1 });
paymentSchema.index({ collectedBy: 1, paymentMethod: 1, status: 1, paymentDate: -1 });
